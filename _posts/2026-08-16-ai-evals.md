...
image: /assets/images/ai-series-5-evals.png
---
...
That last question became **[RAGAssure](https://github.com/SankeerthBoddu/ragassure)**, which is now public as an open-source `0.1.0` alpha and installable from PyPI. I am using the **[Secure Enterprise AI Assistant](https://github.com/SankeerthBoddu/secure-enterprise-ai-assistant)** as its first public system under test: the application owns the runtime authorization boundary, and RAGAssure verifies that the expected evidence behavior still holds after a change.
